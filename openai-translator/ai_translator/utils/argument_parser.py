...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--target_language', type=str, default=None, help='The target language for translation')
        self.parser.add_argument('--output_file_path', type=str, default=None, help='The file path where the translated document will be saved.')
        self.parser.add_argument('--pages', type=str, default=None, help='The specific pages to translate.')
